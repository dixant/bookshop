...
<html>
    <head>
        ...
        <title><s:property value="category.Category"/></title>
        ...
        <table width="100%" border="0" cellspacing="4" cellpadding="1">
            <tr>
                <td align="left" valign="top">
                    <span style="font:30px/32px Georgia,serif; width:300px; color:#990000; height:37px;"><s:property value="category.Category"/></span>
                </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr>
                <td align="left" valign="top" class="Arial13GrayN">
