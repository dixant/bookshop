...
<html>
    <head>
        ...
        <title><s:property value="author.FirstName"/> <s:property value="author.LastName" />'s Profile</title>
        ...
        <table width="100%" border="0" cellspacing="4" cellpadding="1">
            <tr>
                <td colspan="2" align="left" valign="top">
                    <span style="font:30px/32px Georgia,serif; width:300px; color:#990000; height:37px;"><s:property value="author.FirstName"/> <s:property value="author.LastName" /></span>
                </td>
            </tr>
            <tr><td colspan="2">&nbsp;</td></tr>
            <tr>
                <td align="left" valign="top">
                    <img src="getFile.action?columnName=Photograph&tableName=Authors&whereClause=AuthorNo&whereClauseValue=<s:property value="author.AuthorNo" />" width="150px"/>
                </td>
                <td align="left" valign="top">
                    <table cellspacing="0" border="0" cellpadding="4" width="100%" style="border:1px dashed #0099ff;">
                        <tr>
                            <td class="Arial13BrownB" width="20%" align="left" style="border-right:1px dashed #0099ff; border-bottom:1px dashed #0099ff;">
                                Degree:&nbsp;
                            </td>
                            <td class="Arial13grayN" valign="top" width="80%" style="border-bottom:1px dashed #0099ff;">
                                <s:property value="author.Degree" />
                            </td>
                        </tr>
                        <tr>
                            <td class="Arial13BrownB" width="20%" align="left" style="border-right:1px dashed #0099ff; border-bottom:1px dashed #0099ff;">
                            ...
                            <td class="Arial13grayN" valign="top" width="80%" style="border-bottom:1px dashed #0099ff;">
                                <a href='mailto:<s:property value="author.EmailAddress"/>'>
                                    <s:property value="author.EmailAddress" />
                                </a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="Arial13grayN" valign="top" width="80%">
                                <s:property value="author.Speciality" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
				<td colspan="2">
                    <br>
					<span style="font:16px/18px Georgia, serif; text-align:center; width:300px; color:#990000; height:37px;">Books written by <s:property value="author.FirstName"/> <s:property value="author.LastName" /></span>
					<br><br>
